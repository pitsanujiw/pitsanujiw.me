...
const Index = () => {
  const { data } = useSWR<GithubProfile, Error>("/users/pitsanujiw", (url) =>
    ServiceHelper.requestData({ url })
  );
  ...
  return (
    <Main
      meta={
        <Meta
          title='Pitsanu "Jiw" - Profile'
          description="What's about for me and description github"
        />
      }
    >
      <Navbar />
      ...
      <div className="max-w-4xl flex items-center h-auto lg:h-screen flex-wrap mx-auto py-32 lg:my-0 z-40">
        <div
          id="profile"
          className="w-full lg:w-3/5 rounded-lg lg:rounded-l-lg lg:rounded-r-lg shadow-2xl bg-white opacity-75 mx-2 lg:mx-0"
        >
          <div className="p-4 md:p-12 text-center lg:text-left">
            ...
            <div className="mx-auto lg:mx-0 w-4/5 pt-3 border-b-2 border-black opacity-25" />
            ...
            <div className="pt-12 pb-8">
              <button
                onClick={() =>
                  window.open(
                    "https://github.com/pitsanujiw/pitsanujiw.me",
                    "_blank"
                  )
                }
